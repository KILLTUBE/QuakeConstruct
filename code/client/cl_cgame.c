...
// ZOID
	...
	case CG_R_CREATESHADER:
		return re.CreateShader( VMA(1), VMA(2) );
	...
	case CG_R_SETCOLOR:
		re.SetColor( VMA(1) );
		return 0;
	case CG_R_ForceRenderCommands:
		re.ForceRenderCommands(qfalse);
		return 0;
	case CG_R_UpdateRenderTarget:
		re.UpdateRenderTarget( args[1] );
		return 0;
