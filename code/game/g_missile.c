...
trace_t convertTrace( trace_t *trace ) {
	trace_t	traceout;

	traceout.allsolid = trace->allsolid;
	traceout.contents = trace->contents;
	
	traceout.endpos[0] = trace->endpos[0];
	traceout.endpos[1] = trace->endpos[1];
	traceout.endpos[2] = trace->endpos[2];

	traceout.entityNum = trace->entityNum;
	traceout.fraction = trace->fraction;
	traceout.plane = trace->plane;
	traceout.startsolid = trace->startsolid;
	traceout.surfaceFlags = trace->surfaceFlags;
