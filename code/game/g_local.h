...
extern vmCvar_t g_compiled;


//==================================================================

// the "gameversion" client command will print this plus compile date
#define	GAMEVERSION	"luamod"
...
void G_InitLuaPhysics(lua_State *L);
...
void	qlua_UnlinkEntity( gentity_t *e );
void	qlua_LinkEntity( gentity_t *e );
...
#define DAMAGE_THRU_LUA				0x00000016
#ifdef MISSIONPACK
